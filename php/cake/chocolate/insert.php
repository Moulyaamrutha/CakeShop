...
$sql = "INSERT INTO customers(name,phone,address,pincode,item_id,payment) VALUES ('$name',$phone,'$address','$pin','$btn','$payment')";
...
if(strlen($phone)==10){
    ...
    if(mysqli_query($conn, $sql)){
        ...
        echo "<h3>Your Chocolate has been orderd successfully.</h3>";
