...
<head>
  ...
  <div class="header-right">
    <a class="active" href="http://localhost/cake/index.html">Home</a>
  </div>
</div>
</head>
<body>
...
<div class="container">
  <h2>Check Out</h2>
   <h3>
  <%
String query = "select * from cakes where cake_id='cake001'";
...
out.println(rs.getString("price"));
  ...
  <form class="form-horizontal" action="insert.jsp">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="cus">Custom name on cake:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="cus" placeholder="Enter Message if any" name="cus" >
      </div>
    </div>
  ...
  <option value="UPI">UPI</option>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default" name ='btn' value="cake001">Submit</button>
      </div>
    </div>
