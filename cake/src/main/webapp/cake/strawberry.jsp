...
String query = "select * from cakes where cake_id='cake005'";
...
out.println(rs.getString("price"));
  ...
  <form class="form-horizontal" action="insert.jsp">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="cus" placeholder="Enter Message" name="cus">
      </div>
    </div>
  ...
  <option value="UPI">UPI</option>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default" name ='btn' value="cake005">Submit</button>
      </div>
    </div>
